  ...
  ?>
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="last-name">Staff Image
                                    </label>
                                    <div class="col-md-4">
                        ...
                        <!---        <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <a href="admin_profile.php"><button type="button" class="btn btn-danger"><i class="fa fa-times-circle-o"></i> Cancel</button></a>
...
confirm_password='$confirm_password', admin_image='$still_profile' WHERE admin_id = '$id' ")or die(mysql_error());
echo "<script>alert('Successfully Update Admin Info!'); window.location='admin_profile.php'</script>";	
}
									}else{
